...
class Stompy(BaseRobotHumanoid):

    """
    Description
    ------------

    Mujoco environment of the KScale Labs Stompy.
    ...
    **Class**: :class:`loco_mujoco.utils.reward.TargetVelocityReward`
    ...
    def __init__(self, disable_arms=False, disable_back_joint=False, **kwargs):
        ...
        xml_path = (Path(__file__).resolve().parent.parent / "data" / "stompy" / "stompy.xml").as_posix()
    ...
    def _get_ground_forces(self):
        ...
        4 points resulting in a 2*3*2=12 dimensional force vector.
    ...
    def generate(task="walk", dataset_type="real", **kwargs):
        ...
        check_validity_task_mode_dataset(Stompy.__name__, task, None, dataset_type,
                                         *Stompy.valid_task_confs.get_all())
