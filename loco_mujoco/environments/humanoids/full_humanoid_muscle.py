...
if __name__ == '__main__':
    ...
    traj_params = dict(traj_path="/home/moore/DataGeneration/data_generation/FirasRecordedData/00_Datasets/03_converted_to_numpy/02-constspeed_full_humanoid.npz",
    ...
    while True:
        ...
        action = 0.85+0.05*(0.5+0.5*np.tanh(np.random.normal(0.0, 1.0, (action_dim,)))) # compare to normal gaussian noise
        action[:3] = 0.0
