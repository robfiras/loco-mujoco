...
from loco_mujoco.algorithms.experimental import S2PGPPOJax
...
def experiment(config: DictConfig):
    try:
        ...
        train_fn = S2PGPPOJax.build_train_fn(env, agent_conf, mh=mh)
        ...
        save_path = S2PGPPOJax.save_agent(result_dir, agent_conf, agent_state)
        ...
        S2PGPPOJax.play_policy(env, agent_conf, agent_state, deterministic=True, n_steps=200, n_envs=20,
