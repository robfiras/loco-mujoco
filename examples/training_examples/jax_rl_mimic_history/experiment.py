...
from loco_mujoco.algorithms.experimental import HistoryPPOJax
...
def experiment(config: DictConfig):
    try:
        ...
        train_fn = HistoryPPOJax.build_train_fn(env, agent_conf, mh=mh)
        ...
        save_path = HistoryPPOJax.save_agent(result_dir, agent_conf, agent_state)
        ...
        HistoryPPOJax.play_policy(env, agent_conf, agent_state, deterministic=True, n_steps=200, n_envs=20,
                                   record=True, train_state_seed=0, traj=traj)
