...
from loco_mujoco.algorithms.experimental import TD3Jax
...
def experiment(config: DictConfig):
    try:
        ...
        TD3Jax.play_policy(env, agent_conf, agent_state, deterministic=True, n_steps=200, n_envs=20, record=True,
                           traj=traj)
