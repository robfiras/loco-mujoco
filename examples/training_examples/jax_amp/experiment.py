...
def experiment(config: DictConfig):
    try:
        ...
        agent_state = jax.vmap(lambda r: AMPJax.init_agent_state(env, agent_conf, r))(_rng) \
            if config.experiment.n_seeds > 1 else AMPJax.init_agent_state(env, agent_conf, _rng)
