...
def experiment(seed=0):
    ...
    traj_params = dict(traj_path="../datasets/humanoids/02-constspeed_reduced_humanoid_POMDP_1.npz",
    ...
    gamma = 0.99
    horizon = 1000
    mdp = ReducedHumanoidTorque4Ages(gamma=gamma, horizon=horizon, n_substeps=n_substeps, scaling=0.4,
